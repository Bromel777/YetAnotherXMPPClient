...
import org.github.bromel777.yaXMPPc.configs.{XMPPClientSettings, XMPPServerSettings}
import org.github.bromel777.yaXMPPc.programs.Program
import tofu.logging.{Logging, Logs}
import tofu.syntax.logging._
import tofu.syntax.monadic._

final class XMPPClientProgram[F[_]: Logging] private(settings: XMPPClientSettings, socketGroup: SocketGroup) extends Program[F] {
...
object XMPPClientProgram {
  ...
  def make[F[_]: Sync](settings: XMPPClientSettings)(implicit logs: Logs[F, F]): F[Program[F]] =
